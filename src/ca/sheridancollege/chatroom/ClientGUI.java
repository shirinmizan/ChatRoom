...
public class ClientGUI extends JFrame implements ActionListener {
	 ...
	 private static final long serialVersionUID = 1L;
	    ...
	    private JButton login, logout, onlineuser;
	    ...
	    ClientGUI(String host, int port) {
	        ...
	        onlineuser = new JButton("Online users");
	    ...
	    */
        ...
        if(o == logout) {
	        ...
	        if(connected) {
	            ...
	            client.sendMessage(new Message(Message.CHATMESSAGE, tf.getText()));            
	        ...
	        if(o == login) {
	            ...
	            client = new MultithreadedClient(server, port, username, this);
